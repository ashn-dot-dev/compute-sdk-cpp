...
public:
  ...
  /// obtained by some other means than the secret store. New "secrets" created
...
class SecretStore {
public:
  static SecretStore open(std::string name);
  ...
  std::optional<Secret> get(std::string key);
